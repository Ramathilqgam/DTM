...
export default function LoginPage() {
  ...
  const oauthErrorDetails = params.get("details");

  const oauthErrorMessage = {

    google_not_configured: "Google OAuth is not configured. Please contact the administrator.",

    google_failed: "Google sign-in failed. Please try again.",

    google_denied: "Google sign-in was cancelled.",

    google_token_fail: oauthErrorDetails ? `Google authentication failed: ${oauthErrorDetails}` : "Google authentication failed. Please try again.",
  ...
  const handleGoogle = () => {
    ...
    // Check if Google OAuth might not be configured
              ...
              <div className="relative">
                ...
                >
                  ...
                  {showPw ? (
                    ...
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M1 12s4-8 11-8 11 8-4 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
