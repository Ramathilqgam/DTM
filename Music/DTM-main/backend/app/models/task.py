...
class Task:
    ...
    @staticmethod
    def create(title, description, assigned_to, created_by, due_date=None, priority="medium"):
        task_doc = {
            "title": title,
            "description": description,
            "assigned_to": ObjectId(assigned_to) if isinstance(assigned_to, str) else assigned_to,
    ...
    def to_dict(task_doc):
        return {
            ...
            "assigned_to": str(task_doc.get("assigned_to", "")),
